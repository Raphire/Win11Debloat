...
Describe 'ImportConfigToParams' {
    ...
    It 'loads the selected tweaks and deployment settings from an exported config file' {
        $result = ImportConfigToParams -ConfigPath $script:ConfigFixturePath -CurrentBuild 22631
